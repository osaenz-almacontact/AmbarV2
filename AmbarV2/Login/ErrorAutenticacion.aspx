<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorAutenticacion.aspx.cs" Inherits="AmbarV2.Login.ErrorAutenticacion" %>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 text-center error-page">
                                    <h1>ERROR!</h1>
                                    <h4 class="error-title">Usuario inactivo o inexistente</h4>
                                    <p class="error-text text-muted mt-3">Por favor comuníquese con el administrador del sistema.</p>
                                    <br />
                                    <br />
