<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SeleccionYContratacion.aspx.cs" Inherits="AmbarV2.RecursosHumanos.SeleccionYContratacion" %>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>Selección y contratación</strong> </h3>
            </div>
        </div>
        <hr />
                    ...
                    <div class="col-md-8">
                        <div class="left-content">
                            ...
                            <div style="margin-top: 4%">
                                <h3 style="color: #12679B">Beneficios</h3>
                                <ul>
