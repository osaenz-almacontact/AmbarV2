<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InfoLATAM.aspx.cs" Inherits="AmbarV2.InfoOperaciones.InfoLATAM" %>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row mb-2 mb-xl-3">
            <div class="container-fluid">
                <img class="card-img-top" src="../Content/Images/ImgOperaciones/ImgLatam/LatamBanner.jpg" alt="Unsplash">
            </div>
        </div>
        <br />
            ...
            <div class="row">
                <div class="col-xl-4 col-xxl-4">
                    <div class="card flex-fill w-100">
                        <div class="card-header" style="background-color: #2A0183">
