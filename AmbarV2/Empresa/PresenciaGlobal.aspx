<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PresenciaGlobal.aspx.cs" Inherits="AmbarV2.Empresa.PresenciaGlobal" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid p-0">
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>Presencia global</strong> </h3>
            </div>
        </div>
        <hr />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <br />
                <h3 style="color: #00467E;">Las empresas innovadoras saben escuchar y entender la voz del cliente en tiempo real en todos los canales de contacto</h3>
            ...
            <div class="col-md-6">
                <img class="img-thumbnail rounded mr-2 mb-2" src="../Content/Images/Empresa/sede-contact.jpg" />
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-thumbnail rounded mr-2 mb-2" src="../Content/Images/Empresa/Brasile.jpg" />
            </div>
            <div class="col-md-6">

                <br />
                <h3 style="color: #00467E;">Digital Customer Management “made in Italy” for the Brazilian market</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <br />
                <h3 style="color: #00467E;">Dominio de tecnologías innovadoras capaces de generar resultados multidisciplinarios y multilingües</h3>
                <p style="text-align: justify">
            ...
            <div class="col-md-6">
                <img class="img-thumbnail rounded mr-2 mb-2" src="../Content/Images/Empresa/Romania.jpg" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-thumbnail rounded mr-2 mb-2" src="../Content/Images/Empresa/sede-tunisy.jpg" />
            </div>
            <div class="col-md-6">

                <br />
                <h3 style="color: #00467E;">Digital Customer Management “made in Italy” para la Región del Mediterráneo</h3>
                <p style="text-align: justify">
