...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="right-image">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="../Content/Images/Empresa/sede-contact.jpg" />
    ...
    <section class="left-image">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <img src="../Content/Images/Empresa/Brasile.jpg" />
                </div>
                <div class="col-md-6">
    ...
    <section class="right-image">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="../Content/Images/Empresa/Romania.jpg" />
                </div>
            </div>
    ...
    <section class="left-image">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <img src="../Content/Images/Empresa/sede-tunisy.jpg" />
                </div>
                <div class="col-md-6">
